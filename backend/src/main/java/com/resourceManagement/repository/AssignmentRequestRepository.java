...
public interface AssignmentRequestRepository extends JpaRepository<AssignmentRequest, Integer> {
    ...
    boolean existsByAssignmentIdAndRequestTypeAndStatus(Integer assignmentId,
            com.resourceManagement.model.enums.RequestType requestType, RequestStatus status);
}
