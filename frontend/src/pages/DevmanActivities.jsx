...
const DevmanActivities = () => {
    ...
    const handleExportLogHistory = async () => {
        try {
            ...
            const headers = [
                'Entity Type', 'Activity Type', 'Project', 'Resource', 'Role',
                'Description', 'Performed By', 'Timestamp'
            ];
            ...
            const fileName = `My_Activity_Log_${new Date().toISOString().split('T')[0]}.xlsx`;
            ...
            <div className="flex-1 ml-[267px] p-8">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div className="flex bg-white rounded-xl p-1 shadow-sm border border-gray-100">
                        {['extend', 'release', 'assignment', 'project'].map((tab) => (
                            <button
                                ...
                                className={`px-8 py-2.5 font-bold text-sm transition-all duration-200 rounded-lg capitalize ${activeTab === tab
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-2.5 bg-white border border-gray-200 rounded-xl text-gray-700 hover:bg-gray-50 transition-all font-bold text-sm shadow-sm"
                    >
                                                    ...
                                                    <tr key={item.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                                        ...
                                                        <td className="py-5 px-6">
                                                            <div className="flex justify-center">
                                                                <span 
                                                                    className={`px-3 py-1 rounded-full text-[10px] font-bold ${item.status === 'REJECTED' ? 'cursor-pointer hover:opacity-80 transition-all' : ''}`}
